...
const calculator = operator => {
    ...
    if (!isOperatorValid(operator) || !isNumberValid(number1, number2)){
        return false;
    }

    return (x,y) => operation[operator](x,y);
}
...
*/
const showOperationMessage = (op, n1, n2) => 'A operação ' + n1 + ' ' + op + ' ' + n2 + ' =';
